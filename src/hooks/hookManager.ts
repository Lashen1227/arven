 ...
 */
export function findGitDir(from: string = process.cwd()): string | null {
 ...
 */
export function installHook(projectRoot: string = process.cwd()): {
  success: boolean;
  message: string;
  hookPath: string;
} {
 ...
 */
export function uninstallHook(projectRoot: string = process.cwd()): {
  success: boolean;
  message: string;
} {
  const gitDir = findGitDir(projectRoot);
